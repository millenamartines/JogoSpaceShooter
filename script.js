...
function moveLaser(laser) {
    let laserInterval = setInterval(() => {
        ...
        aliens.forEach((alien) => { // comparando se cada alien doi atingido, se sim, troca o src da imagem
...
// função de game over
function gameOver() {
    window.removeEventListener('keyboard', flyShip);
